# IUS spec file for php56e-pecl-redis, forked from:
...
%changelog
* Fri Jan 12 2017 Gregory Boddin <gregory@siwhine.net> - 2.2.8-3
- Initial import from IUS
...
- Rebuilding against php56e-5.6.6-2.ius as it is now using bundled PCRE.
