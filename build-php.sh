...
yum install httpd-devel libvpx-devel gettext-devel libtiff-devel libwebp-devel perl-generators enchant-devel libicu-devel recode-devel  aspell-devel libtidy-devel libmcrypt-devel tokyocabinet-devel  gdbm-devel gmp-devel t1lib-devel libxslt-devel net-snmp-devel firebird-devel libc-client-devel libacl-devel systemtap-sdt-devel libtool-ltdl-devel gcc-c++ libedit-devel smtpdaemon libstdc++-devel pam-devel curl-devel bzip2-devel libpng-devel git tar expat-devel freetds-devel db4-devel rpm-build postgresql-devel mysql-devel sqlite-devel wget unixODBC-devel nss-devel doxygen automake libtool autoconf zlib-devel libselinux-devel libuuid-devel pcre-devel openldap-devel lua-devel libxml2-devel  openssl-devel -y
